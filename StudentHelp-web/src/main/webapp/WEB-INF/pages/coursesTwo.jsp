...
<body>
	<!--顶部-->
      ...
      <div class="ddiv">
        <div class="teacher_center" style="height:1450px;" >
        	<h1>5月周末班级设置：</h1>
            <hr color="#46474C" class="hra"  style="width:165px;" size="1" />
            <hr color="#BAC9C6"  class="hrb" style="margin-left:272px;" size="1" />
            <table class="gridtable" width="1000px" style="text-align:center; margin-top:40px; font-family:'微软雅黑'; line-height:30px;">
                ...
                <tr>
                	...
                	<td>雅思基础<br />听说读写</td>
                	<td>5.23-8.9<br />每周六/日<br />9:30-14:00或<br/>15:00-19:30</td>
