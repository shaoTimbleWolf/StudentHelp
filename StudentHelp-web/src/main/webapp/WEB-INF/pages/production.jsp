...
<body  onLoad="setupZoom();">
        ...
        <div class="teacher_center" style="height:1200px;" >
           ...
           <div align="center" class="photoblock">
            ...
            <div class="photoblock-many">
             	<a href="images/IMG_0466.JPG" title="Why“学生帮”？--- 拉丁语Veritas 真理的音译。长久以来，出国考试培训都被烙上了技巧的印记。">
   ...
   <a href="images/IMG_0460.JPG" title="学生帮的尔--- 学生。一切教育的主体，也是我们服务的主体。"><img src="images/IMG_0460_x.JPG" width="161" height="123" border="0" alt="" id="img-mwsf-21" class="photo" /></a> 
   ...
   <a href="images/IMG_0476.JPG" title="我们不做高高在上的说教者，我们不是知识的复读机，我们希望陪伴你们，引领你们经历人生中第一次的全力付出。"><img src="images/IMG_0476_x.JPG" width="161" height="123" border="0" alt="" id="img-mwsf-27" class="photo" /></a>
             ...
             <h1 style="font-weight:100px; font-family:'微软雅黑'; margin-left:-880px;">学生帮教育简介：</h1>
            <p style="margin-top:20px; font-size:15px;font-family:'微软雅黑'; color:#000; text-align:left; text-indent:2em; line-height:20px;">Why“学生帮”？--- 拉丁语Veritas 真理的音译。长久以来，出国考试培训都被烙上了技巧的印记。我们疯狂的刷题，我们死记机经，我们寄希望于模板和老师们经验之谈的猜题技巧。
...
因为我们忽略了一切教育的本质：追求真理。当我们总是浮于表面，只追逐分数本身的时候，我们辛苦而又麻木的教育，我们不求甚解，不去探寻知识背后的关联。我们忘记了语言是文化与思维的载体，机械的记忆与翻译永远不会让我们达到master的境界。
            ...
            <h1 style="font-weight:100px; font-family:'微软雅黑'; margin-left:-880px;">学生帮的特色：</h1>
            ...
            <h1 style="font-weight:100px; font-family:'微软雅黑'; margin-left:-880px;">学生帮的优势：</h1>
