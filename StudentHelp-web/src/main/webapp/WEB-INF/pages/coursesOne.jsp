      ...
      <div  class="ddiv">
        <div class="teacher_center" style="height:1200px;" >
            ...
            <table class="gridtable" width="1000px" style="text-align:center; margin-top:40px; font-family:'微软雅黑'; line-height:30px;">
                ...
                <tr>
                	<td>雅思基础班<br /> 6-8人<br /> 全日制班</td>
                	<td>雅思基础<br />听说读写</td>
                	<td>5.18-6.20<br />每周一至六<br />10：00—19:00</td>
                	<td>听说读写各9次<br />共72课时</td>
                	<td>7200元</td>
                </tr>
                <tr>
                	<td>雅思强化班<br /> 6-8人<br /> 全日制班</td>
                	<td>雅思强化<br />听说读写</td>
                	<td>5.18-6.20<br />每周一至六<br />10：00—19:00</td>
