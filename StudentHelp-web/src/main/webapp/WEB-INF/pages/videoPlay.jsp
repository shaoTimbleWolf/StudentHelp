...
<head>
<meta charset="UTF-8">
<title>${videoPlay.videoname}</title>
<script type="text/javascript"
	src="${pageContext.request.contextPath }/chplayer/chplayer.min.js"></script>
...
<body>
	<div id="video" style="width: 60%; height: 500px;"></div>
	<br><br><br><hr width="60%">
	<div>
		<h3>视频名称：${videoPlay.videoname}</h3>
		<h5>所属年级：${videoPlay.videograde}</h5>
		<h5>所属科目：${videoPlay.videocourse}</h5>
		<h5>知识点介绍：${videoPlay.videoknowledge}</h5>
	</div>
	<script type="text/javascript">
		var videoObject = {
			...
			preview : {
				src : [ 'screenshot/mydream_en1800_1010_01.jpg',
						'screenshot/mydream_en1800_1010_02.jpg' ],
				scale : 2
			...
			video : [ 'http://192.168.77.129:8888/${videoPlay.url}',
					'video/mp4', 'examples.webm', 'video/webm' ],
